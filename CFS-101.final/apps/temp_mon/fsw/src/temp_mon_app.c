...
#define TEMP_INCREASING  1
#define TEMP_DECREASING  2

#define TEMP_NOMINAL  0
#define TEMP_HOT      1
#define TEMP_COLD     2
...
** Author(s):  Jane Smith 
**
** History:  Date Written  2017-01-13
...
int32 TEMP_MON_InitData()
{
    ...
    g_TEMP_MON_AppData.iCurTempVal = 0;
    g_TEMP_MON_AppData.iOldTempVal = 0;
...
void TEMP_MON_ProcessNewData()
{
    ...
    while (1)
    {
        ...
        if (iStatus == CFE_SUCCESS)
        {
            ...
            switch (TlmMsgId)
            {
                case TEMP_IO_OUT_DATA_MID:
                    ...
                    g_TEMP_MON_AppData.iOldTempVal = g_TEMP_MON_AppData.iCurTempVal;
                    g_TEMP_MON_AppData.iCurTempVal = dataPtr->iTempValue;
                    /**/
                    /* Determine if it's increasing/decreasing */
                    g_TEMP_MON_AppData.sDirection = TEMP_NOCHANGE;
                    if (g_TEMP_MON_AppData.iCurTempVal > g_TEMP_MON_AppData.iOldTempVal)
                    {
                        g_TEMP_MON_AppData.sDirection = TEMP_INCREASING;
                    }
                    else if (g_TEMP_MON_AppData.iCurTempVal < g_TEMP_MON_AppData.iOldTempVal)
                    {
                    ...
                    if (g_TEMP_MON_AppData.iCurTempVal >= g_TEMP_MON_AppData.iHotLimit)
                    {
                        g_TEMP_MON_AppData.sRange = TEMP_HOT;
                    }
                    else if (g_TEMP_MON_AppData.iCurTempVal <= g_TEMP_MON_AppData.iColdLimit)
                    {
                        g_TEMP_MON_AppData.sRange = TEMP_COLD;
                    }
                    break;
                ...
                default:
                    CFE_EVS_SendEvent(TEMP_MON_MSGID_ERR_EID, CFE_EVS_ERROR,
                                      "TEMP_MON - Recvd invalid TLM msgId (0x%08X)", (int)TlmMsgId);
                    break;
            }
        }
        else if (iStatus == CFE_SB_NO_MESSAGE)
        ...
        {
            CFE_EVS_SendEvent(TEMP_MON_PIPE_ERR_EID, CFE_EVS_ERROR,
                              "TEMP_MON: TLM pipe read error (0x%08X)", (int)iStatus);
            g_TEMP_MON_AppData.uiRunStatus = CFE_ES_APP_ERROR;
            break;
        }
    }
        ...
        switch (uiCmdCode)
        {
            case TEMP_MON_NOOP_CC:
                ...
                CFE_EVS_SendEvent(TEMP_MON_CMD_INF_EID, CFE_EVS_INFORMATION,
                                  "TEMP_MON - Recvd NOOP cmd (%d)", (int)uiCmdCode);
                break;
            /**/
            case TEMP_MON_RESET_CC:
                ...
                CFE_EVS_SendEvent(TEMP_MON_CMD_INF_EID, CFE_EVS_INFORMATION,
                                  "TEMP_MON - Recvd RESET cmd (%d)", (int)uiCmdCode);
                break;
            /**/
            ...
            default:
                g_TEMP_MON_AppData.HkTlm.usCmdErrCnt++;
                CFE_EVS_SendEvent(TEMP_MON_MSGID_ERR_EID, CFE_EVS_ERROR,
                                  "TEMP_MON - Recvd invalid cmdId (%d)", (int)uiCmdCode);
                break;
        }
    }
}
...
{
    g_TEMP_MON_AppData.HkTlm.iTempValue = g_TEMP_MON_AppData.iCurTempVal;
