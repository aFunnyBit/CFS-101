...
int32 TEMP_IO_InitData()
{
    ...
    g_TEMP_IO_AppData.iNewTempVal = 0;
...
{
    g_TEMP_IO_AppData.iCurTempVal = g_TEMP_IO_AppData.iNewTempVal;
    g_TEMP_IO_AppData.iNewTempVal = g_TEMP_IO_AppData.iCurTempVal + g_TEMP_IO_AppData.iDeltaVal;
}
        ...
        switch (uiCmdCode)
        {
            case TEMP_IO_NOOP_CC:
                ...
                CFE_EVS_SendEvent(TEMP_IO_CMD_INF_EID, CFE_EVS_INFORMATION,
                                  "TEMP_IO - Recvd NOOP cmd (%d)", (int)uiCmdCode);
                break;
            /**/
            case TEMP_IO_RESET_CC:
                ...
                CFE_EVS_SendEvent(TEMP_IO_CMD_INF_EID, CFE_EVS_INFORMATION,
                                  "TEMP_IO - Recvd RESET cmd (%d)", (int)uiCmdCode);
                break;
            /**/
            case TEMP_IO_SET_CURRENT_TEMP_CC:
                cmdPtr = (TEMP_IO_IntArgCmd_t*)MsgPtr;
                g_TEMP_IO_AppData.iNewTempVal = cmdPtr->iValue;
                g_TEMP_IO_AppData.HkTlm.usCmdCnt++;
                CFE_EVS_SendEvent(TEMP_IO_CMD_INF_EID, CFE_EVS_INFORMATION,
                                  "TEMP_IO - Recvd SET_CURRENT_TEMP cmd (%d) - %d",
                                  (int)uiCmdCode, (int)g_TEMP_IO_AppData.iNewTempVal);
                break;
            /**/
            ...
            default:
                g_TEMP_IO_AppData.HkTlm.usCmdErrCnt++;
                CFE_EVS_SendEvent(TEMP_IO_MSGID_ERR_EID, CFE_EVS_ERROR,
                                  "TEMP_IO - Recvd invalid cmdId (%d)", (int)uiCmdCode);
                break;
        }
    }
}
...
{
    g_TEMP_IO_AppData.OutData.iTempValue = g_TEMP_IO_AppData.iNewTempVal;
