...
class CHeaderParser():
	...
	def findDataTypeNew(self, dataTypeOrig, paramName):
		if '[' in paramName:
			return '--string'
		elif dataTypeOrig == 'uint8' or dataTypeOrig == 'int8' or dataTypeOrig == 'boolean':
			return '--byte'
		elif dataTypeOrig == 'uint16' or dataTypeOrig == 'int16':
			return '--half'
		elif dataTypeOrig == 'uint32' or dataTypeOrig == 'int32' or dataTypeOrig == 'float':
			return '--word'
		elif dataTypeOrig == 'uint64' or dataTypeOrig == 'int64' or dataTypeOrig == 'double':
			return '--double'
		else:
			return ''
