...
SCH_LAB_ScheduleTable_t SCH_LAB_ScheduleTable[SCH_LAB_MAX_SCHEDULE_ENTRIES] =
  {
     ...
     /**/
     { TEMP_IO_WAKEUP_MID,  1, 0 },  /* Send 1hz Wake-up message */
     { TEMP_MON_WAKEUP_MID, 1, 0 },
#if 0
     { SC_SEND_HK_MID,       4, 0 },
     ...
     { LC_SEND_HK_MID,       4, 0 },
#endif
     { TEMP_IO_SEND_HK_MID,  1, 0 },  /* Housekeeping requests go out every second */
     { TEMP_MON_SEND_HK_MID, 1, 0 },
     /**/
